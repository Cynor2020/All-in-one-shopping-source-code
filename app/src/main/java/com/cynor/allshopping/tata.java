...
public class tata extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webview.setWebViewClient(new tata.HelloWebViewClient());
        webview.getSettings().setJavaScriptEnabled(true);
        webview.loadUrl("https://www.tatacliq.com/");
    ...
    public void onBackPressed() { //if user presses the back button do this
        if (webview.isFocused() && webview.canGoBack()) { //check if in webview and the user can go back
            ...
            new AlertDialog.Builder(this) //alert the person knowing they are about to close
                    .setTitle("EXIT TATA CLiQ")
                    .setMessage("Are you sure. You want to close Tata CLiQ?")
